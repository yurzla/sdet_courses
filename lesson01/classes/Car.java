...
public class Car extends Vehicle implements ICar {
    ...
    public String toString() {
        return String.format("%s, %d, %s", super.toString(), 
                                passengerNumber, CarClass.toString(carClass));
    }

    protected Car() {
    }
    protected Car(String stateNumber, String owner, String manufacturer,
                     int passengerNumber, CarClass carClass)
    {
    ...
    public static Car create(String stateNumber, String owner, 
