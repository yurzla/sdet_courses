...
public class Truck extends Vehicle implements ITruck {
    ...
    public String toString() {
        return String.format("%s, %s, %d", super.toString(), TruckTrailer.toString(trailer), loadCapasityKG);
    }

    protected Truck() {
    }
    protected Truck(String stateNumber, String owner, String manufacturer, TruckTrailer trailer, int loadCapasityKG)
    {
        super(stateNumber, owner, manufacturer); // позвали конструктор родительского класса
        this.trailer = trailer;
        this.loadCapasityKG = loadCapasityKG;
    }
    public static Truck create(String stateNumber, String owner, String manufacturer, TruckTrailer trailer, int loadCapasityKG) {
        return new Truck(stateNumber, owner, manufacturer, trailer, loadCapasityKG);
    }
}
